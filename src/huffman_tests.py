...
class TestList(unittest.TestCase):
    def test_cnt_freq(self):
        ...
        secondlist = cnt_freq("empty_file.txt")
        seclst = [0]*256
        self.assertListEqual(freqlist[97:104], anslist)
        self.assertListEqual(secondlist,seclst)
        with self.assertRaises(FileNotFoundError):
            freqlist2 = cnt_freq("filedoesnotexist.txt")
    ...
    def test_01_textfile(self):
        huffman_encode("file_WAP.txt", "file_WAPout.txt")
        ...
        # self.assertTrue(filecmp.cmp("file_WAPout_compressed.txt", "file_WAP_out_compressed.txt"))
        '''
